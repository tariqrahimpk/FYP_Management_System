...
$filetmp=$_FILES['image']['tmp_name'];
  ...
  $upload = "file_folder";
  $query="insert into store_thesis set project_name='$pro_name',project_description='$desc',sup_id='$project_supervisor', project_file='$filename',std_id='$student_id'";
  $execute=mysqli_query($mysqli,$query);
  if($execute){
    move_uploaded_file($filetmp,"$upload/$filename");
      $_SESSION['msg']='Your Thesis file has been uploaded successfully';
    $_SESSION['col']='success'; 
?>
<meta http-equiv="refresh" content="3; URL=http://localhost/project1/uploadThesis.php" />
...
<div class="col-md-6" style="background-color: PeachPuff;">
  ...
  <div class="row" style="margin-top:20px;">
    ...
    <textarea required="" name="desc" cols="80" rows="5" placeholder="Name and registation of other student In Group if Have: OR write Nil" style="margin-top:20px;"></textarea>
